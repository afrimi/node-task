...
const fetchCommissionConfigs = async function fetchConfigurations() {
    ...
    const cashIn = fetchApi("http://private-38e18c-uzduotis.apiary-mock.com/config/cash-in");
    const cashOutNatural = fetchApi("http://private-38e18c-uzduotis.apiary-mock.com/config/cash-out/natural");
    const cashOutLegal = fetchApi("http://private-38e18c-uzduotis.apiary-mock.com/config/cash-out/juridical");

    const [cashInConfig, cashOutNaturalConfig, cashOutLegalConfig] = await Promise.all([cashIn, cashOutNatural, cashOutLegal]);
